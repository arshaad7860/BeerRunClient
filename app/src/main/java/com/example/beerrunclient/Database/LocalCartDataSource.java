package com.example.beerrunclient.Database;
...
public class LocalCartDataSource implements CartDataSource{
    ...
    @Override
    public Single<CartItem> getItemWithAllOpionsInCart(String uid, String categoryId, String foodId, String foodSize, String foodAddon,String restaurantId) {
